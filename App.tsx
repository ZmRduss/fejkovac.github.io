...
const App = () => {
  ...
  if (file === undefined && !imageUrl) {
    return (
      <>
        <FlexColumn gap="1em">
          <SectionHeading>Vyber metodu:</SectionHeading>
          <Option
            name="method"
            value="imgbb"
          ...
          >
            ...
            <BulletPoint>Obrázek bude po nahrání automaticky smazán po 10 minutě</BulletPoint>
            <BulletPoint>Podpora WEBP obrázků</BulletPoint>
          </Option>
          <Option
            name="method"
            value="imgur"
          ...
          >
            ...
            <BulletPoint>Soubor nebude smazán</BulletPoint>
            <BulletPoint>Nemusí fungovat na některé vyhledavače
            </BulletPoint>
          </Option>
        </FlexColumn>
        <FlexColumn gap="1em" align="center">
          <MainHeading>Stačí vložit obrázek!</MainHeading>
          ...
          <InputBlock errorText={urlError}>
            <URLInput
              placeholder="Napiš odkaz na obrázek"
  ...
  return (
    <FlexColumn gap="1em" align="flex-start">
      ...
      {error && (
        <section>
          <SectionHeading>Chyba:</SectionHeading>
          <code>{error}</code>
        </section>
      )}
      {isLoading && <Loading>Nahrávání obrázku...</Loading>}
      {imageUrl && (
        <FlexColumn gap="2em">
          <section>
            <SectionHeading>Link na obrázek:</SectionHeading>
